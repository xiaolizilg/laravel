            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.hospital.hotal.update', [$hospital->id, $hotal->id]) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="desc" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="描述" value="{{$hotal->desc}}" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="price" data-parsley-trigger="change" data-parsley-type="integer" data-parsley-required="true" placeholder="费用" value="{{$hotal->price}}" />
                        </div>
                    </div>
                    <div class="form-group">
