            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.hospital.doctor.update', [$hospital->id, $doctor->id]) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="real_name" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="姓名" value="{{$doctor->real_name}}" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="success_rate" data-parsley-trigger="change" data-parsley-type="integer" placeholder="成功率" value="{{$doctor->success_rate}}" />
                        </div>
                    </div>
                    <div class="form-group">
