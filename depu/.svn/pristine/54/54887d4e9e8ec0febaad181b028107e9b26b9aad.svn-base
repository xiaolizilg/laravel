            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.hospital.taxi.update', [$hospital->id, $taxi->id]) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="price" data-parsley-trigger="change" data-parsley-maxlength="300" data-parsley-required="true" placeholder="费用" value="{{$taxi->price}}" />
                        </div>
                    </div>
                    <div class="form-group">
