            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.hospital.medical.update', [$hospital->id, $medical->id]) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="price" data-parsley-trigger="change" data-parsley-type="integer" data-parsley-required="true" placeholder="费用" value="{{$medical->price}}" />
                        </div>
                    </div>
                    <div class="form-group">
