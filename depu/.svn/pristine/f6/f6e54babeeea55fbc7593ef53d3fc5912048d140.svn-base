            ...
            <div class="panel-body panel-form">
                <form method="POST" action="{{ route('backend.project.update', $project->id) }}" class="form-horizontal form-bordered" data-parsley-validate="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="info" data-parsley-trigger="change" data-parsley-maxlength="80" placeholder="简介" value="{{$project->info}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4">费用 :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" name="price" data-parsley-trigger="change" data-parsley-maxlength="80" data-parsley-required="true" placeholder="费用" value="{{$project->price}}" />
                        </div>
                    </div>
                    <div class="form-group">
