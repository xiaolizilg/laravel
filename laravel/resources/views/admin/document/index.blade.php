...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a href="{{url('admin/document/create')}}" class="btn btn-primary ">添加</a>
                        </div>
                            ...
                            @if(isset($list))
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-success" href="{{url('admin/document/edit',['id'=>$data->id])}}"> 编辑 </a>
    ...
    function del(id){
        layer.confirm('您确定要删除？', {
          ...
          $.get("{{url('admin/document/del')}}",{id:id},function(rs){
    ...
    function status(id,state){
        ...
        $.get("{{url('admin/document/status')}}",{id:id,status:state},function(rs){
            if(rs.error == 0){
    ...
    function sorts(id,_this) {
       sort =  _this.value;
       // alert(sort);
         $.get("{{url('admin/document/sort')}}",{id:id,sort,sort},function(rs){
            if(rs.error == 0){
                layer.msg('操作成功', {icon: 1});
                setTimeout(function(){
                    window.location.reload(); 
